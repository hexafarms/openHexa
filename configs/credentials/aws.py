...
def prepare_configs(setup:Dict, cv_mode:str):
    ...
    s3_client = _connect_aws_s3(AWS_KEY, AWS_SECRET, AWS_REGION)
    ...
    meta_path = os.path.join('/openHexa', 'meta', 'hexa_meta.json')
    ...
    if not os.path.exists(config_file_path):
        ...
        s3_client.download_file(blink_bucket_name, aws_config_path, str(config_file_path))
